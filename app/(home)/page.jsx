      ...
      {/* Home Section */}
        ...
        <section className="fixed top-0  z-20 w-full min-h-screen md:min-h-screen ">
          ...
          <div className="p-4 md:p-8 flex flex-row absolute bottom-0 justify-between w-full z-30 ">
            <p className=" basis-1/4 md:basis-1/2 text-xs md:text-base self-end text-secondary text-nowrap">
              *Film Director<br />
              *Documentary Filmmaker
            </p>
            <span className="relative md:basis-1/2 basis-3/4 md:max-w-max  overflow-hidden justify-self-end  md:relative    md:p-0  origin-bottom-right block">
