            ...
            <nav className=" overflow-hidden  p-4 md:p-8 top-0 flex justify-between flex-row text-black fixed w-full z-50">
                <Link name="Home" className="z-50 overflow-hidden " href="/">
                    <motion.span className="origin-top-left max-h-[60px] max-w-[260px] md:max-h-max md:max-w-max overflow-hidden inline-block">
                        ...
                        <motion.svg initial={{ y: -120 }} className="home-header relative origin-top-left scale-50 md:scale-88" width="460" height="112" viewBox="0 0 460 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M463.069 112H430.909V0H463.069V112Z" fill="#090909" />
                            <path d="M428.492 112H368.172V0H400.332V93.28H428.492V112Z" fill="#090909" />
                            <path d="M365.755 112H305.435V0H337.595V93.28H365.755V112Z" fill="#090909" />
                            <path d="M301.488 112H270.128L267.088 93.28H248.368L245.488 112H213.968L235.568 0H280.048L301.488 112ZM264.208 74.72L257.808 34.88L251.408 74.72H264.208Z" fill="#090909" />
                            <path d="M216.373 112H156.053V0H188.213V93.28H216.373V112Z" fill="#090909" />
                            <path d="M149.015 112H85.8154V0H149.015V18.72H117.975V44.48H146.775V63.2H117.975V93.28H149.015V112Z" fill="#090909" />
                            <path d="M56.7344 112H0.734375V0H56.7344C62.281 0 67.0277 1.76 70.9744 5.28C74.921 8.69333 76.8944 13.1733 76.8944 18.72V93.28C76.8944 98.8267 74.921 103.36 70.9744 106.88C67.0277 110.293 62.281 112 56.7344 112ZM41.8544 93.28C42.601 93.28 43.241 93.0133 43.7744 92.48C44.4144 91.9467 44.7344 91.2533 44.7344 90.4V21.6C44.7344 20.7467 44.4144 20.0533 43.7744 19.52C43.241 18.9867 42.601 18.72 41.8544 18.72H32.8944V93.28H41.8544Z" fill="#090909" />
                        </motion.svg>
