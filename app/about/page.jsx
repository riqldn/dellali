...
<div className='h-[20vh] bottom-0 z-30 fixed w-full bg-blue-white'>
            ...
            <section className=' bg-white min-h-screen w-full'>
                <div className="top-0 pointer-events-none main justify-center  flex flex-col min-h-screen overflow-hidden w-full fixed z-40 text-secondary font-instrument">
                    ...
                    <motion.span className="absolute left-4 scale-30 md:scale-100 bottom-4 origin-bottom-left overflow-hidden justify-self-end   origin-bottom block">
